...
const MainPage = () => {
    ...
    return (
        ...
        <div className='flex flex-col items-center justify-center'>
            <h1 className="text-lg md:text-5xl italic ">Inspired by the Aurora, Designed for You. </h1>
            ...
            <div className='md:hidden'>
                <img src='https://aurora-gem-images-bucket.s3.eu-north-1.amazonaws.com/pics/rings/jewelery-2.avif' alt='jewelery' />
                <img src='https://aurora-gem-images-bucket.s3.eu-north-1.amazonaws.com/pics/rings/jewelery-1.avif' alt='jewelery' />
                <img src='https://aurora-gem-images-bucket.s3.eu-north-1.amazonaws.com/pics/bracelets/jewelery-6.avif' alt='jewelery' />
                <img src="https://aurora-gem-images-bucket.s3.eu-north-1.amazonaws.com/pics/rings/jewelery-5.avif" alt='jewelery' />
                <img src="https://aurora-gem-images-bucket.s3.eu-north-1.amazonaws.com/pics/rings/jewelery-6.avif" alt='jewelery' />
